 ...
 * @author nader
 */
public class ProjectsByName extends List implements CommandListener, Runnable {
String s="";
    ...
    Display disp;
    public ProjectsByName(String title, int b) {
    ...
    public void run() {
        try {
            ...
            HttpConnection hc = (HttpConnection) Connector.open("http://127.0.0.1/parsing2016/select2.php?nom="+s);
