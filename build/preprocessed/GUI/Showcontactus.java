...
Font.STYLE_ITALIC, 
Font.SIZE_MEDIUM));
      g.drawString("notre num :"+r[0].getNumero(),20, hi+110, Graphics.LEFT| Graphics.BASELINE);
        g.drawString("notre fax :"+r[0].getFax(), 20, hi+130, Graphics.LEFT| Graphics.BASELINE);
        g.drawString("notre adresse :"+r[0].getAdresse(), 20, hi+150, Graphics.LEFT| Graphics.BASELINE);
