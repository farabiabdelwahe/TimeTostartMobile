 ...
 * @author GSC
 */
public class AddFeedback  extends Form implements CommandListener {
    int fp ;
      ...
      Image  img;  
    public AddFeedback(String title,int i) {
         super(title);
         fp=i;
               try {
    ...
    public void commandAction(Command c, Displayable d) {
        ...
        Midlet.INSTANCE.disp.setCurrent(new MainProject("Projects"));
             ...
             if (c==feebak){
                                 try {
ht=(HttpConnection) Connector.open("http://127.0.0.1/parsing2016/insert.php?text="+urlEncode(cin.getString())+"&iduser="+Midlet.INSTANCE.u.getId()+"&idproject="+this.fp);
                ;
